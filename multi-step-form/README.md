...
I learned a lot in this project ranging from how to put the layout and beautify it using styled-components to using ReactJs properly.
The newest thing for was using FormContext from react-hook-form
